	...
	function apt_admin_dashboard(){
	  global $wp_styles;
		...
		if(is_user_logged_in()){
			...
			<iframe onload='apt_admin_iframemodify()'  id="apt_admin_dashboard_style" style="max-width:100%;" height="600px" width="940px"  src="https://appts.ufound.us/wp-admin/admin.php?page=dashboard_submenu"></iframe>
			<?php 
			$output = ob_get_clean();
			return $output;
		}
