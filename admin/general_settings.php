									...
									<tr>
										...
										<td>
											<div class="form-group">
												...
												<input <?php if($apt_settings->appointment_multi_location=='E') { echo ' checked '; }?> type="checkbox" id="appointment_multi_location" class="" name="ck"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												...
												<input <?php if($apt_settings->appointment_zipcode_booking=='E') { echo ' checked '; }?> type="checkbox" id="appointment_zipcode_booking" class="" name="ck"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
									...
									<tr>
										...
										<td>
											<div class="form-group">
												...
												<input type="checkbox" class="apt-toggle-pd" <?php if($apt_settings->appointment_partial_deposit_status=='E') { echo ' checked="checked" '; }?> id="appointment_partial_deposit_status" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
										...
										<td>
											<div class="form-group col-md-12 np">
												<label class="manage-right toggle-large" for="appointment_multiple_booking_sameslot">
													<input <?php if($apt_settings->appointment_multiple_booking_sameslot=='E') { echo ' checked="checked" '; }?> type="checkbox" class="apt-toggle-sh" id="appointment_multiple_booking_sameslot"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
										...
										<td>
											<div class="form-group">
												<label class="toggle-large" for="appointment_appointment_auto_confirm">
													<input <?php if($apt_settings->appointment_appointment_auto_confirm=='E') { echo ' checked="checked" '; }?> type="checkbox" id="appointment_appointment_auto_confirm" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
											<a class="apt-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo __("With Enable of this feature, Appointment request from clients will be auto confirmed.","apt");?>"><i class="fa fa-info-circle fa-lg"></i></a>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div class="form-group">
												<label class="toggle-large" for="appointment_dayclosing_overlap">
													<input <?php if($apt_settings->appointment_dayclosing_overlap=='E') { echo ' checked="checked" '; }?> type="checkbox" id="appointment_dayclosing_overlap"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
										...
										<td>
											<div class="form-group">
												<label class="toggle-large" for="booking_cart_description">
													...
													<input <?php if($apt_settings->appointment_cart_description=='E') { echo ' checked="checked" '; }?> type="checkbox" id="appointment_cart_description"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
										...
										<h4 class="panel-title">
											...
											<div class="apt-enable-disable-right pull-right">
												<label class="toggle-large" for="appointment_payment_gateways_status">
													<input type="checkbox" <?php if($apt_settings->appointment_payment_gateways_status=='E'){ echo 'checked="checked"';} ?> class="apt-toggle-sh" id="appointment_payment_gateways_status" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_locally_payment_status">
																	<input type="checkbox" <?php if($apt_settings->appointment_locally_payment_status=='E'){ echo 'checked="checked"';} ?> class="apt-toggle-sh" id="appointment_locally_payment_status" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																</label>
															</div>
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_payment_method_Paypal">
																	<input <?php if($apt_settings->appointment_payment_method_Paypal=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_payment_method_Paypal" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																</label>
															</div>
																		...
																		<td>
																			<div class="form-group">
																				<label class="toggle-large" for="appointment_paypal_guest_checkout">
																					<input <?php if($apt_settings->appointment_paypal_guest_checkout=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_paypal_guest_checkout" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																		...
																		<td>
																			<div class="form-group">
																				<label class="toggle-large" for="appointment_paypal_testing_mode">
																					<input <?php if($apt_settings->appointment_paypal_testing_mode=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_paypal_testing_mode" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_payment_method_Stripe">
																	<input <?php if($apt_settings->appointment_payment_method_Stripe=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_payment_method_Stripe" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_payment_method_payumoney">
																	<input <?php if($apt_settings->appointment_payment_method_Payumoney=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_payment_method_Payumoney" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																</label>
															</div>
														</h4>
													</div>
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_payment_method_Paytm">
																	<input <?php if($apt_settings->appointment_payment_method_Paytm=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_payment_method_Paytm" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																</label>
															</div>
														</h4>
													</div>
																		...
																		<td>
																			<div class="form-group">
																				<label class="toggle-large" for="appointment_paytm_testing_mode">
																					<input <?php if($apt_settings->appointment_paytm_testing_mode=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_paytm_testing_mode" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																				</label>
																			</div>	
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for=		"appointment_payment_method_2Checkout">
																	<input <?php if($apt_settings->appointment_payment_method_2Checkout=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_payment_method_2Checkout" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td>
																			<div class="form-group">
																				<label class="toggle-large" for="appointment_paypal_testing_mode">
																					<input <?php if($apt_settings->appointment_2checkout_testing_mode=='E'){ echo 'checked="checked"';} ?> type="checkbox" class="apt-toggle-sh" id="appointment_2checkout_testing_mode" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
										...
										<td>
											<div class="form-group">
												<label class="toggle-large" for="appointment_manager_email_notification_status">
													<input  <?php if($apt_settings->appointment_manager_email_notification_status=='E'){ echo 'checked="checked"';} ?> type="checkbox" id="appointment_manager_email_notification_status" class="apt-toggle-sh"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="form-group">
												<label class="toggle-large" for="appointment_service_provider_email_notification_status">
													<input <?php if($apt_settings->appointment_service_provider_email_notification_status=='E'){ echo 'checked="checked"';} ?> type="checkbox" id="appointment_service_provider_email_notification_status" class="apt-toggle-sh"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
										</td>
									</tr>
										...
										<h4 class="panel-title">
											...
											<div class="apt-enable-disable-right pull-right">
												<label class="toggle-large" for="appointment_sms_reminder_status">
													<input <?php if($apt_settings->appointment_sms_reminder_status=='E'){echo "checked='checked'";} ?> type="checkbox" class="apt-toggle-sh" name="appointment_sms_reminder_status" id="appointment_sms_reminder_status"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
												</label>
											</div>
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_sms_noti_twilio">
																	<input <?php if($apt_settings->appointment_sms_noti_twilio=='E'){echo "checked='checked'";} ?> type="checkbox" class="apt-toggle-sh" id="appointment_sms_noti_twilio" name="appointment_sms_noti_twilio"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																</label>
															</div>
														</h4>
													</div>
																...
																<td colspan="2">
																	<div class="form-group">
																		<label class="toggle-large" for="appointment_twilio_service_provider_sms_notification_status">
																			<input <?php if($apt_settings->appointment_twilio_service_provider_sms_notification_status=='E'){echo "checked='checked'";} ?> type="checkbox" name="appointment_twilio_service_provider_sms_notification_status" id="appointment_twilio_service_provider_sms_notification_status"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																...
																<td colspan="2">
																	<div class="form-group">
																		<label class="toggle-large" for="appointment_twilio_admin_sms_notification_status">
																			<input <?php if($apt_settings->appointment_twilio_admin_sms_notification_status=='E'){echo "checked='checked'";} ?> type="checkbox" name="appointment_twilio_admin_sms_notification_status" id="appointment_twilio_admin_sms_notification_status" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_sms_noti_plivo">
																	<input <?php if($apt_settings->appointment_sms_noti_plivo=='E'){echo "checked='checked'";} ?> type="checkbox" class="apt-toggle-sh" id="appointment_sms_noti_plivo" name="appointment_sms_noti_plivo"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																</label>
															</div>
														</h4>
													</div>
																	...
																	<td colspan="2">
																		<div class="form-group">
																			<label class="toggle-large" for="appointment_plivo_service_provider_sms_notification_status">
																				<input <?php if($apt_settings->appointment_plivo_service_provider_sms_notification_status=='E'){echo "checked='checked'";} ?> type="checkbox" name="appointment_plivo_service_provider_sms_notification_status" id="appointment_plivo_service_provider_sms_notification_status"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																			</label>
																		</div>	
																		<a class="apt-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo __("Enable or Disable, Send SMS to Service provider for appointment booking info.","apt");?>"><i class="fa fa-info-circle fa-lg"></i></a>
																	</td>
														...
														<h4 class="panel-title">
															...
															<div class="apt-enable-disable-right pull-right">
																<label class="toggle-large" for="appointment_sms_noti_nexmo">
																	<input <?php if($apt_settings->appointment_sms_noti_nexmo=='E'){echo "checked='checked'";} ?> type="checkbox" class="apt-toggle-sh" id="appointment_sms_noti_nexmo" name="appointment_sms_noti_nexmo"  data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																</label>
															</div>
														</h4>
													</div>
																	...
																	<td colspan="2">
																		<div class="form-group">
																			<label class="toggle-large" for="appointment_nexmo_send_sms_client_status">
																				<input <?php if($apt_settings->appointment_nexmo_send_sms_client_status=='E'){echo "checked='checked'";} ?> type="checkbox" name="appointment_nexmo_send_sms_client_status" id="appointment_nexmo_send_sms_client_status" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
																			</label>
																		</div>	
																		<a class="apt-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo __("Enable or Disable, Send SMS to client for appointment booking info.","apt");?>"><i class="fa fa-info-circle fa-lg"></i></a>
																	</td>
										...
										<tbody id="coupon_list">
											...
											<tr id="coupon_detail<?php echo $apt_coupons->id;?>">	
												...
												<td>
													...
													<input <?php if($apt_coupons->coupon_status=='E'){ echo "checked='checked'";} ?> data-cid="<?php echo $apt_coupons->id;?>" class="apt-toggle-medium-input apt_update_couponstatus" type="checkbox" id="promocode_status<?php echo $apt_coupons->id;?>" data-toggle="toggle" data-size="small" data-on="<?php echo __("Enable","apt");?>" data-off="<?php echo __("Disable","apt");?>" data-onstyle="success" data-offstyle="danger" />
													</label>
												</td>
												<td>
